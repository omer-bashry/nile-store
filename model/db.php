...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   switch($action) {
       case 'createProduct':
           echo $db->createProduct($_POST['name'], $_POST['price']);
           break;
       case 'readProducts':
           echo $db->readProducts();
           break;
       case 'updateProduct':
           echo $db->updateProduct($_POST['id'], $_POST['name'], $_POST['price']);
           break;
       case 'deleteProduct':
           echo $db->deleteProduct($_POST['id']);
           break;
       case 'createReceipt':
           echo $db->createReceipt($_POST['product_id'], $_POST['quantity']);
           break;
       case 'readReceipts':
           echo $db->readReceipts();
           break;
       case 'updateReceipt':
           echo $db->updateReceipt($_POST['id'], $_POST['product_id'], $_POST['quantity']);
           break;
       case 'deleteReceipt':
